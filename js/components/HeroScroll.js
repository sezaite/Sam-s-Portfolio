...
class HeroScroll {
    ...
    generateHeroAlbums() {
        ...
        for (let album of dataCopy) {
            ...
            <div class="project" style ="background-image: url("https://sezaite.github.io/sam-portfolio/${album.imgLink}");">
            <div class="blur" style ="background-image: url("https://sezaite.github.io/sam-portfolio/${album.imgLink}");"></div>
